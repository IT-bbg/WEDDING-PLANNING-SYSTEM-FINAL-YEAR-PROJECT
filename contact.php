...
<head>
    ...
    <style>
        body {
            font-family: 'Calibri', 'Times New Roman', Calibri ;
            line-height: 1.9em;
            margin-bottom: 3%;
            margin-top: 3%;
            width: 100%;
                        ...
                        <div class="col-md-8">
                            <table class="table table-sm" style="font-size: 12px;">
                                <tr>
                                    ...
                                    <td><i class="mdi mdi-deskphone mr-3"></i> +254797779103</td>
                                </tr>
                                <tr>
                                    <td>6th Floor, Nakuru City</td>
                                    <td><i class="mdi mdi-phone mr-3"></i> +25401739558</td>
                                </tr>
                                <tr>
                                    <td>Street Jomo Kenyatta nkr</td>
                                    <td><i class="mdi mdi-email mr-3"></i> ivynjeri3246@gmail.com</td>
                                </tr>
                            </table>
                        </div>
                        <div class="col-md-4">
                        ...
                        <form action="" method="post" style="font-size: 12px;">
                            <div class="row">
                                ...
                                <div class="col-md-6 pr-2">
                                    <iframe src="https://www.bing.com/search?pglt=41&q=kabarak+university+location&cvid=a27d29ad536d464a9bf934179651fe61&gs_lcrp=EgZjaHJvbWUqBggBEAAYQDIGCAAQRRg5MgYIARAAGEDSAQg4MjI5ajBqMagCALACAA&FORM=ANNTA1&PC=U531" width="95%" height="395" frameborder="0" style="border:0" allowfullscreen></iframe>
                                </div>
                            </div>
